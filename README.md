...
5. Использован контроль версий в работе над этим небольшим проектом (используя несколько коммитов)
...
* В решении задачи при помощи создания второго массива обнаружил недостаток: длина второго массива ссотвествует длине первого массива. Вследствии чего при формировании второго массива в нем присутствую пустые элементы. 
* Решил данную задачу при помощи динамического списка List. 